...
import { LoadConfirmation } from 'src/app/modules/loadconfirmation/loadconfirmation';
import { LoadConfirmationServiceService } from 'src/app/services/loadconfirmation/load-confirmation-service.service';
...
export class LoadConfirmationComponent implements OnInit {
  ...
  displayedColumns = ['LoadConfirmationID'];
  EditView = false; 
  displayMessage = ''; 
  isDisabled = true; 
  AddDisabled = false;
